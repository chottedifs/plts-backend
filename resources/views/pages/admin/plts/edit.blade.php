            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('master-plts.update', $plts->id) }}">
                                @method('put')
                                @csrf
                                <div class="row">
                                    <div class="mb-3 col-lg-12">
                                        <label for="nama_lengkap" class="form-label">Nama Lengkap</label>
                                        <input type="text" name="nama_lengkap" class="form-control @error('nama_lengkap') is-invalid @enderror" id="nama_lengkap" autofocus value="{{ old("nama_lengkap", $plts->nama_lengkap) }}">
                                        @error('nama_lengkap')
                                ...
                                <div class="row">
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <input type="number" name="nip" autofocus class="form-control @error('nip') is-invalid @enderror" id="nip" value="{{ old('nip', $plts->nip) }}">
                                        @error('nip')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <select name="lokasi_id" id="lokasi_id" class="form-control @error('lokasi_id') is-invalid @enderror">
                                            ...
                                            @if (old('lokasi_id', $plts->lokasi_id) == $lokasi->id)
                                ...
                                <div class="row">
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <option value="{{ $plts->jenis_kelamin }}" hidden selected>{{ $plts->jenis_kelamin }}</option>
                                            @if ($plts->jenis_kelamin)
