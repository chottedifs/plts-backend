                            ...
                            <form method="post" action="{{ route('master-petugas.update', $petugas->id) }}">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <input type="number" name="nik" disabled class="form-control" id="nik" value="{{ old('nik', $petugas->nik) }}" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-lg-12">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control @error('alamat') is-invalid @enderror">{{ old('alamat', $petugas->alamat) }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
