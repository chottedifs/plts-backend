                            ...
                            <form method="post" action="{{ route('master-admin.update', $admin->id) }}">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <input type="number" name="nik" class="form-control" disabled value="{{ old('nik', $admin->nik) }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-lg-12">
                                        <label for="email" class="form-label">Alamat Email</label>
                                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" value="{{ old('email', $admin->Login->email) }}">
                                        @error('email')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <option value="{{ $admin->jenis_kelamin }}" hidden selected>{{ $admin->jenis_kelamin }}</option>
                                ...
                                <div class="row">
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control @error('alamat') is-invalid @enderror">{{ old('alamat', $admin->alamat) }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
